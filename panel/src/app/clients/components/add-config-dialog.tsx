...
export function AddConfigClientDialog({ clientId, serverId, clientName }: Props) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <Tooltip>
                ...
                <TooltipContent>
                    <p>Add config for {clientName}</p>
                </TooltipContent>
            </Tooltip>
            <DialogContent className="sm:max-w-131.25">
                <DialogHeader>
                    <DialogTitle>Add new config for {clientName}</DialogTitle>
                    <DialogDescription>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <DialogFooter>
                            ...
                            <Button type="submit" disabled={createConfig.isPending}>
                                ...
                                {createConfig.isPending ? 'Adding...' : 'Add Config'}
                            </Button>
                        </DialogFooter>
                    </form>
                </Form>
